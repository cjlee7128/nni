...
if __name__ == "__main__":
    ...
    for w1 in [2, 4, 8, 16, 32]: 
        ...
        for c1 in [1, 2, 3, 4]: 
            ...
            for s1 in [1, 2]: 
                stride_stages=f'{s1}'
                for output_size in [2, 4, 8, 12, 16, 24, 32, 40]: 
                    # if i < 3: 
                    #     i = i + 1 
                    #     continue 
