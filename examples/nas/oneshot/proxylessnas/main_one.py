...
# SearchMobileNet -> SearchTinyMLNet -> SearchTinyMLNet_div 
from model import SearchTinyMLNet_div 
...
if __name__ == "__main__":
    ...
    if args.train_mode == 'retrain':
        ...
        with fixed_arch(args.exported_arch_path):
            ...
            # SearchTinyMLNet -> SearchTinyMLNet_div 
            model = SearchTinyMLNet_div(width_stages=[int(i) for i in args.width_stages.split(',')],
